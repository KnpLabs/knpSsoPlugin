...
class knpSsoSecurityUser extends sfBasicSecurityUser
{
  protected $user = null;

  /**
   * Initializes the knpSsoSecurityUser object.
   *
  ...
  public function initialize(sfEventDispatcher $dispatcher, sfStorage $storage, $options = array())
  {
    ...
    if (!$this->isAuthenticated())
    {
      ...
      $this->getAttributeHolder()->removeNamespace('knpSsoSecurityUser');
      $this->user = null;
    }
  }
   ...
   *
   * @param knpSsoUser $user The knpSsoUser id
  ...
  {
    // signin
    $this->setAttribute('user_id', $user->getId(), 'knpSsoSecurityUser');
    ...
    if ($remember)
    {
      ...
      // remove old keys
      Doctrine_Core::getTable('knpSsoRememberKey')->createQuery()
        ->delete()
  ...
  /**
   * Returns the related knpSsoUser.
   *
   * @return knpSsoUser
   */
  public function getGuardUser()
  {
    if (!$this->user && $id = $this->getAttribute('user_id', null, 'knpSsoSecurityUser'))
    {
      $this->user = Doctrine_Core::getTable('knpSsoUser')->find($id);
  ...
  /**
   * Returns the knpSsoUser object's username.
   *
   * @return string
   */
  ...
  /**
   * Returns the knpSsoUser object's email.
   *
   * @return string
   */
  ...
  /**
   * Returns the Doctrine_Collection of single knpSsoPermission objects.
   *
